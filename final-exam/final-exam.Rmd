...
plot(x, y, xlab = "number of doors", ylab = "difference in probabilities", type = "b")
```
...
plot(density(class), main = "average yearly hospital charge of a class")
hist(class, main = "average yearly hospital charge of a class")
```
...
plot(density(quantile1), xlim = c(0.3, 2.6))
lines(density(quantile2))
lines(density(quantile3))
```
